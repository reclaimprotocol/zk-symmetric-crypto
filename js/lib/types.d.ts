...
export type ZKEngine = 'snarkjs' | 'gnark' | 'expander' | 'barretenberg';
 ...
 */
    ...
    ultrahonkVerify(publicSignals: ZKProofPublicSignals, proof: ZKProof, logger?: Logger): Promise<boolean>;
};
export declare const isBarretenbergOperator: (operator: ZKOperator | BarretenbergOperator | OPRFOperator) => operator is BarretenbergOperator;
