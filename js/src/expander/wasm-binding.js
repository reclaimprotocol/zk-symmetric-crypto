 ...
 */
export function load_circuit(alg, bytes) {
 ...
 * @param {Uint8Array} bytes
 */
export function load_solver(alg, bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
export function is_circuit_loaded(alg) {
 ...
 * @returns {boolean}
 */
export function is_solver_loaded(alg) {
 ...
 * @returns {Uint8Array}
 */
export function prove(alg, priv_input_bits, pub_input_bits) {
 ...
 * @returns {boolean}
 */
export function verify(alg, pub_input_bits, proof_data) {
...
export const SymmetricCryptoAlgorithm = Object.freeze({ ChaCha20:0,"0":"ChaCha20", });
