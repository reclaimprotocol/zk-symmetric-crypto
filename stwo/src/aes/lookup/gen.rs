...
impl TraceGenerator {
    ...
    /// Append nibble decomposition (lo, hi) for a byte.
    ...
    fn xor_byte_trace(&mut self, col: &mut usize, a: Simd<u8, 16>, b: Simd<u8, 16>) -> Simd<u8, 16> {
        ...
        // Append nibble decomposition of a
        self.append_nibbles(col, a);
        // Append nibble decomposition of b
        self.append_nibbles(col, b);
        // Append XOR results for nibbles
